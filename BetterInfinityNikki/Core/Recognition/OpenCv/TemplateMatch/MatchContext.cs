...
using OpenCvSharp;
using static BetterInfinityNikki.Core.Recognition.OpenCv.TemplateMatch.MiniMapMatchConfig;

namespace BetterInfinityNikki.Core.Recognition.OpenCv.TemplateMatch;
